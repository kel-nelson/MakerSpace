...
namespace makerspace.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        // POST: /Manage/AreaMemberships_Add
        [HttpPost]
        public ActionResult AreaMemberships_AddEdit(int user_id, int area_id, int membership_type_id, int id=0)
        {
            try
            {
